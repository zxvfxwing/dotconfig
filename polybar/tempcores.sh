...
do
    ...
    do
        if (( "${tempCore[$iCore]}" < "${temperaturesValues[$iTemp]}"  )); then
            tmpEcho="%{F${temperaturesColors[$iTemp]}}${tempCore[$iCore]}"
...
do
    if (( "$sum" < "${temperaturesValues[$iTemp]}" )); then
        ...
        #tmpEcho="%{F${temperaturesColors[$iTemp]}}${temperaturesIcons[$iTemp]}$degree"
        tmpEcho="${temperaturesIcons[$iTemp]}$degree"
